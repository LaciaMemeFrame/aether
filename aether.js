...
void main() {
	...
	`}var ho=class extends St{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new As(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Vi(5,5,5),r=new je({name:"CubemapFromEquirect",uniforms:di(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ct,blending:Kt});r.uniforms.tEquirect.value=t;let a=new ft(s,r),o=t.minFilter;return t.minFilter===Jn&&(t.minFilter=Mt),new xa(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){let r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}};function Sm(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,d=!1){return h==null?null:d?a(h):r(h)}function r(h){if(h&&h.isTexture){let d=h.mapping;if(d===ya||d===Ma)if(e.has(h)){let _=e.get(h).texture;return o(_,h.mapping)}else{let _=h.image;if(_&&_.height>0){let y=new ho(_.height);return y.fromEquirectangularTexture(i,h),e.set(h,y),h.addEventListener("dispose",c),o(y.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){let d=h.mapping,_=d===ya||d===Ma,y=d===Zn||d===fi;if(_||y){let m=t.get(h),f=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==f)return n===null&&(n=new uo(i)),m=_?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{let E=h.image;return _&&E&&E.height>0||y&&E&&l(E)?(n===null&&(n=new uo(i)),m=_?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function o(h,d){return d===ya?h.mapping=Zn:d===Ma&&(h.mapping=fi),h}function l(h){let d=0,_=6;for(let y=0;y<_;y++)h[y]!==void 0&&d++;return d===_}function c(h){let d=h.target;d.removeEventListener("dispose",c);let _=e.get(d);_!==void 0&&(e.delete(d),_.dispose())}function u(h){let d=h.target;d.removeEventListener("dispose",u);let _=t.get(d);_!==void 0&&(t.delete(d),_.dispose())}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:p}}function bm(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&ai("WebGLRenderer: "+n+" extension not supported."),s}}}function Tm(i,e,t,n){let s={},r=new WeakMap;function a(p){let h=p.target;h.index!==null&&e.remove(h.index);for(let _ in h.attributes)e.remove(h.attributes[_]);h.removeEventListener("dispose",a),delete s[h.id];let d=r.get(h);d&&(e.remove(d),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(p,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function l(p){let h=p.attributes;for(let d in h)e.update(h[d],i.ARRAY_BUFFER)}function c(p){let h=[],d=p.index,_=p.attributes.position,y=0;if(_===void 0)return;if(d!==null){let E=d.array;y=d.version;for(let A=0,M=E.length;A<M;A+=3){let T=E[A+0],b=E[A+1],C=E[A+2];h.push(T,b,b,C,C,T)}}else{let E=_.array;y=_.version;for(let A=0,M=E.length/3-1;A<M;A+=3){let T=A+0,b=A+1,C=A+2;h.push(T,b,b,C,C,T)}}let m=new(_.count>=65535?bs:Ss)(h,1);m.version=y;let f=r.get(p);f&&e.remove(f),r.set(p,m)}function u(p){let h=r.get(p);if(h){let d=p.index;d!==null&&h.version<d.version&&c(p)}else c(p);return r.get(p)}return{get:o,update:l,getWireframeAttribute:u}}function Em(i,e,t){let n;function s(p){n=p}let r,a;function o(p){r=p.type,a=p.bytesPerElement}function l(p,h){i.drawElements(n,h,r,p*a),t.update(h,n,1)}function c(p,h,d){d!==0&&(i.drawElementsInstanced(n,h,r,p*a,d),t.update(h,n,d))}function u(p,h,d){if(d===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,p,0,d);let y=0;for(let m=0;m<d;m++)y+=h[m];t.update(y,n,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function wm(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:De("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Am(i,e,t){let n=new WeakMap,s=new pt;function r(a,o,l){let c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=u!==void 0?u.length:0,h=n.get(o);if(h===void 0||h.count!==p){let w=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",w)};h!==void 0&&h.texture.dispose();let d=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,y=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],f=o.morphAttributes.normal||[],E=o.morphAttributes.color||[],A=0;d===!0&&(A=1),_===!0&&(A=2),y===!0&&(A=3);let M=o.attributes.position.count*A,T=1;M>e.maxTextureSize&&(T=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);let b=new Float32Array(M*T*4*p),C=new vs(b,M,T,p);C.type=Qt,C.needsUpdate=!0;let x=A*4;for(let U=0;U<p;U++){let F=m[U],V=f[U],H=E[U],D=M*T*4*U;for(let G=0;G<F.count;G++){let K=G*x;d===!0&&(s.fromBufferAttribute(F,G),b[D+K+0]=s.x,b[D+K+1]=s.y,b[D+K+2]=s.z,b[D+K+3]=0),_===!0&&(s.fromBufferAttribute(V,G),b[D+K+4]=s.x,b[D+K+5]=s.y,b[D+K+6]=s.z,b[D+K+7]=0),y===!0&&(s.fromBufferAttribute(H,G),b[D+K+8]=s.x,b[D+K+9]=s.y,b[D+K+10]=s.z,b[D+K+11]=H.itemSize===4?s.w:1)}}h={count:p,texture:C,size:new ye(M,T)},n.set(o,h),o.addEventListener("dispose",w)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let d=0;for(let y=0;y<c.length;y++)d+=c[y];let _=o.morphTargetsRelative?1:1-d;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Cm(i,e,t,n,s){let r=new WeakMap;function a(c){let u=s.render.frame,p=c.geometry,h=e.get(c,p);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){let d=c.skeleton;r.get(d)!==u&&(d.update(),r.set(d,u))}return h}function o(){r=new WeakMap}function l(c){let u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}var Rm={[Bs]:"LINEAR_TONE_MAPPING",[Os]:"REINHARD_TONE_MAPPING",[zs]:"CINEON_TONE_MAPPING",[hi]:"ACES_FILMIC_TONE_MAPPING",[Gs]:"AGX_TONE_MAPPING",[Hs]:"NEUTRAL_TONE_MAPPING",[Vs]:"CUSTOM_TONE_MAPPING"};function Im(i,e,t,n,s,r){let a=new St(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,resolveDepthBuffer:!1,resolveStencilBuffer:!1}),o=null,l=null,c=new lt;c.setAttribute("position",new it([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new it([0,2,0,0,2,0],2));let u=new Wi({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
#define LOW_PRECISION`),e}var Ug={[Fs]:"SHADOWMAP_TYPE_PCF",[Xi]:"SHADOWMAP_TYPE_VSM"};function Ng(i){return Ug[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var Fg={[Zn]:"ENVMAP_TYPE_CUBE",[fi]:"ENVMAP_TYPE_CUBE",[ks]:"ENVMAP_TYPE_CUBE_UV"};function Bg(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Fg[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var Og={[fi]:"ENVMAP_MODE_REFRACTION"};function zg(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Og[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Vg={[ll]:"ENVMAP_BLENDING_MULTIPLY",[$c]:"ENVMAP_BLENDING_MIX",[Kc]:"ENVMAP_BLENDING_ADD"};function Gg(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Vg[i.combine]||"ENVMAP_BLENDING_NONE"}function Hg(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function kg(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=Ng(t),c=Bg(t),u=zg(t),p=Gg(t),h=Hg(t),d=wg(t),_=Ag(r),y=s.createProgram(),m,f,E=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);let A=E+m+a,M=E+f+o,T=wu(s,s.VERTEX_SHADER,A),b=wu(s,s.FRAGMENT_SHADER,M);s.attachShader(y,T),s.attachShader(y,b),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function C(F){if(i.debug.checkShaderErrors){let V=s.getProgramInfoLog(y)||"",H=s.getShaderInfoLog(T)||"",D=s.getShaderInfoLog(b)||"",G=V.trim(),K=H.trim(),Y=D.trim(),ne=!0,q=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(ne=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,T,b);else{let j=Cu(s,T,"vertex"),te=Cu(s,b,"fragment");De("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
void main() {
  ...
  float n = snoise(vec3(position.x * 0.55, uTime * 0.02, position.z * 0.55));
  vec3 pos = position;
  pos.y += n * (0.012 + uBass * 0.03);
  vRad = r;
...
void main() {
  ...
  float r = vRad;
  float kepler = uTime * (0.28 / max(r * 0.22, 0.18));
  float a = theta + kepler;
  float rings = pow(0.5 + 0.5 * sin(r * 22.0 - kepler * 3.5), 5.0);
  float rings2 = pow(0.5 + 0.5 * sin(r * 41.0 + kepler * 1.6), 7.0);
  float arms = pow(max(sin(a * 3.0 - r * 5.2 + uTime * 0.16), 0.0), 4.0);
  float grain = snoise(vec3(cos(a) * r * 1.8, sin(a) * r * 1.8, uTime * 0.08));
  float spec = texture2D(uSpectrum, vec2(fract(vUv.x + kepler * 0.012), 0.5)).r;
  float heat = pow(clamp(1.0 - vUv.y, 0.0, 1.0), 2.6);
  vec3 ember = vec3(0.5, 0.16, 0.05);
  vec3 gold = vec3(0.7, 0.38, 0.12);
  vec3 ash = vec3(0.12, 0.14, 0.18);
  vec3 moon = vec3(0.18, 0.36, 0.48);
  vec3 warm = mix(ember, gold, heat);
  vec3 cool = mix(ash, moon, heat * 0.35 + uHigh * 0.25);
  vec3 col = mix(warm, cool, uCentroid);
  float structure = rings * 0.75 + rings2 * 0.45 + arms * (0.35 + uMid * 0.4);
  structure += spec * 0.55 * (0.35 + rings);
  structure += grain * 0.08;
  structure *= 0.55 + uSwell * 0.4 + uEnergy * 0.28 + uOnset * 0.06;
  structure *= 1.0 + uFlux * 0.35;
  float doppler = 0.5 + 0.5 * sin(theta);
  col *= mix(vec3(1.14, 0.78, 0.5), vec3(0.55, 0.8, 1.12), mix(doppler, 0.5, 0.4));
  col *= 0.15 + structure;
  float inner = smoothstep(0.0, 0.028, vUv.y);
  float outer = 1.0 - smoothstep(0.52, 0.9, vUv.y);
  float alpha = inner * outer * clamp(structure, 0.0, 1.0);
  alpha *= 0.7 + uSwell * 0.18 + uMid * 0.1;
